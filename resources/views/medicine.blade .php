...
<title>Cardiology | Free Bootstrap Responsive Website Templates</title>
<!-- Bootstrap -->
...
<div class="top-header"><!-- top header -->
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-12"><a class="logo" href="index.html"><img src="images/logo.png" alt=""></a> </div>
      <div class="col-md-9 hidden-sm hidden-xs">
        <div class="top-link">
          <div class="row">
            <div class="col-md-6">
              <i class="fa fa-clock-o"></i>Mon to sat: 10:00am to 6:00pm
            </div>
            <div class="col-md-3">
          ...
          <div class="col-md-10 col-sm-12">
            <div id="navigation" class="navigation">
              <ul>
                ...
                <li><a href="blog.html" title="Blog" class="animsition-link">Consultant</a>
                <ul>
                  <li><a href="{{url('/medicine/')}}" title="Medicine" class="animsition-link">Medicine</a></li>
                  <li><a href="blog-single.html" title="Blog Single" class="animsition-link">Surgery</a></li>
                  <li><a href="blog-single.html" title="Blog Single" class="animsition-link">Gynaecology</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="post-holder mb40">
          <div class="post-img mb20"> <a href="#" class="imghover"><img src="images/post-img-1.jpg" alt="" class="img-responsive"></a> </div>
          <div class="post-block">
            <div class="post-header mb20">
              <h3 class="post-title mb20"><a href="#" class="title">Pacemakers and Cardiovascular<br> Defibrillators</a></h3>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="post-holder mb40">
          <div class="post-img mb20"> <a href="#" class="imghover"><img src="images/post-img-2.jpg" alt="" class="img-responsive"></a> </div>
          <div class="post-block">
            <div class="post-header mb20">
              <h3 class="post-title mb20"><a href="#" class="title">Medication Management and Heart Disease Services</a></h3>
              <div class="post-meta"><!-- post meta --> 
                <span class="meta-date"><i class="fa fa-calendar"></i> August 24, 2017 </span>
                <span class="meta-comment"><i class="fa fa-comments"></i> <a href="#" class="meta-link">05 Comment </a></span> </div>
              <!-- /.post meta --> 
      ...
      <div class="col-md-4 col-sm-4">
        <div class="post-holder mb40">
          <div class="post-img mb20"> <a href="#" class="imghover"><img src="images/post-img-3.jpg" alt="" class="img-responsive"></a> </div>
          <div class="post-block">
            <div class="post-header mb20">
              <h3 class="post-title mb20"><a href="#" class="title">The Importance of Good Medication Management</a></h3>
              <div class="post-meta"><!-- post meta --> 
                <span class="meta-date"><i class="fa fa-calendar"></i> August 24, 2017 </span>
                <span class="meta-comment"><i class="fa fa-comments"></i> <a href="#" class="meta-link">05 Comment </a></span> </div>
              <!-- /.post meta --> 
...
<div class="bg-primary pdt60 pdb60">
  <div class="container">
    <div class="row">
      <div class="col-md-9 col-sm-9">
        <h1 class="text-white">We'll treat you with best of care Diagnostic</h1>
      </div>
      <div class="col-md-3 col-sm-3">
        <a href="#" class="btn btn-white">make an appointment</a>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-md-3 col-sm-3">
        <div class="footer-widget"><!-- footer-widget -->
          ...
          <ul class="listnone bullet bullet-angle-right mb0">
            <li><a href="service-detail.html" title="Diagnostic Cardiac">Diagnostic Cardiac</a></li>
            <li><a href="service-detail.html" title="Vascular Dignostic">Vascular Dignostic</a></li>
            <li><a href="service-detail.html" title="Invasive Procedures">Invasive Procedures</a></li>
            <li><a href="service-detail.html" title="Heart Conditions Treated">Heart Conditions Treated</a></li>
            <li><a href="service-detail.html" title="Vein Clinic Services">Vein Clinic Services</a></li>
          </ul>
        </div>
        <!-- /.footer-widget --> 
      </div>
      <div class="col-md-2 col-sm-2">
        <div class="footer-widget"><!-- footer-widget -->
          ...
          <ul class="listnone bullet bullet-angle-right mb0">
            ...
            <li><a href="service-list.html" title="Services">Services</a></li>
            <li><a href="blog.html" title="Blog">Blog</a></li>
            <li><a href="contact-us.html" title="Contact Us">Contact Us</a></li>
            <li><a href="testimonials.html" title="Testimonilas">Testimonilas</a></li>
          </ul>
        </div>
        <!-- /.footer-widget --> 
      </div>
...
<div class="tiny-footer"><!-- tiny-footer -->
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 text-center">
        <p>Cardio © 2016  |  Privacy Policy</p>
      </div>
    </div>
  </div>
</div>
