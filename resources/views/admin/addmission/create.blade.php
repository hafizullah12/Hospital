...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
    <form action="{{url('/patient-addmission')}}" method="post">
    {{csrf_field()}} 
    ...
    {!! Form::text('room_no',null,['class'=>'form-control','required'=>'required']) !!}
    </div>
    <div class="form-group"> 
    {!! Form::label('Under Consultant info') !!}
    {!! Form::text('consultant',null,['class'=>'form-control','required'=>'required']) !!}
    </div>
