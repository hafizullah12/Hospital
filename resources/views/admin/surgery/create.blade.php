...
<button class="btn btn-warning pull-right"><a href="{{route('surgery.index')}}">Show All </a></button>
<div class="panel panel-primary">
    <div class="panel-heading text-center">Add New Surgery</div>
    <div class="panel-body">
    {!! Form::open(['action'=>'SurgeryController@store','files'=>true]) !!}
